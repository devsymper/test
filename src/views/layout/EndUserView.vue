<template>
    <v-app id="symper-platform-app">
        <ba-sidebar @show-user-detail="showMyInfo = true" v-if="false" />
        <v-main style="height:100vh;">
            <v-container fluid fill-height class="pa-0">
                <div v-if="false" class=" app-header-bg-color" style="border-bottom:1px solid #e6e5e5; width: calc(100% - 5px)">
