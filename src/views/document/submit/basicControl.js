...
export default class BasicControl extends Control {
    ...
    renderRichTextControl() {
        ...
        let selector = '';
        let self = this;
        let toolbar = 'undo redo | styleselect | lineheightselect | lineheight | fontselect | fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | outdent indent | link image | code';
