...
export default class PageControl extends LayoutControl {
    ...
    setHiddenPage() {
        this.ele.closest('.s-control-tab-page').find('.sb-page-active').removeClass('sb-page-active');
        this.ele.closest('.s-control-tab-page').find('.page-active').removeClass('page-active')
        let pageContentEle = this.ele.closest('.s-control-tab-page').find('.list-page-content [s-page-content-id="' + this.id + '"]');
