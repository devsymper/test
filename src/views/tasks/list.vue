<template>
    <div>
        <v-row class="mr-0 ml-0">
            <v-col :cols="!sideBySideMode ? 12 : 4">
                    ...
                    <v-col cols="10" class="text-right">
                        ...
                        >
                            ...
                            <v-list dense light nav>
                                <v-subheader>{{this.$t("sortBy")}}</v-subheader>
                                <v-list-item-group 
                                    v-model="sortBy" 
                                    multiple
                                >
                ...
                <v-row class="ml-0 mr-0" v-if="!sideBySideMode">
                    <v-col cols="12" class="list-tasks pt-0 pb-0">
                        <v-row>
                            <v-col :cols="sideBySideMode ? 12 : 4" class="pl-8 subtitle-2">
                                {{$t("tasks.header.name")}}
                            </v-col>
                            ...
                            <v-col cols="2" v-if="!sideBySideMode" class="text-right subtitle-2">
                                <v-btn 
                                    icon small 
                ...
                <v-divider></v-divider>
                <v-row class="ml-0 mr-0">
                    <v-col cols="12" class="pt-0 pb-0 pl-0 pr-0">
                        <v-expansion-panels
                            tile
                            flat
                            multiple
                            ...
                            >
                                ...
                                <v-expansion-panel-content class="pl-0 pr-0">
                                    ...
                                    >
                                        ...
                                        <v-col cols="2" v-if="!sideBySideMode"></v-col>
                                    </v-row>
