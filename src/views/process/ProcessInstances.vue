                ...
                <v-row class="ml-0 mr-0 list-instances">
                    <div class="instance-item" v-for="(item, idx) in listInstances" :key="idx" @click="selectProcessInstance(item)">
                        ...
                        <div class="instance-item-creator float-left">
                            <i class="mdi mdi-account-cog mr-1 fs-14 grey--text"></i><span class="grey--text fs-12">{{item.startUserId}}</span>
                        </div>
                        <div class="instance-item-time float-right">
                            <i class="mdi mdi-clock-time-nine-outline fs-13 mr-1 grey--text"></i><span class="grey--text fs-12">{{$moment(item.startTime).fromNow()}}</span>
                        </div>
                    </div>
                </v-row>
            </v-col>
