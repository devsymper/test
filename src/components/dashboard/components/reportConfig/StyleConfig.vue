...
import LineAndClusteredColumn from "@/components/dashboard/reports/LineAndClusteredColumn.chart.js";
export default {
	components:{
		VuePerfectScrollbar,
		FormTpl,
	...
	methods:{
		testRenderChart(){
            let lineAndClusteredColumn = new LineAndClusteredColumn();
            this.testRowconfig.style = this.styleConfig;
            lineAndClusteredColumn.translate(this.testRowconfig,{cellId:"asssss1333",data:this.testData});
		},
		onSearch(vl){
			if(this.delayTimer){
