<template>
    <div class="symper-timeline-tree-view">
        <div class="milestone-datetimes">
            <div v-for="(times, date) in listMilestoneTime" :key="date" class="milestone-datetime-item">
                <div class="milestone-date" :style="{
                        'line-height': minItemHeight+'px',
                }">{{date}}</div>
                <div class="milestone-times">
                    <div v-for="(time, idx) in times" :key="idx" class="milestone-time-item" :style="{
        ...
        <div class="tree-view">
            <TimelineTreeviewItem :item="treeData" :itemIndent="itemIndent" :minItemHeight="minItemHeight">
...
<style>
.symper-timeline-tree-view>.tree-view>.time-line-treeview-item>.milestone-marker{
    display: none;
}
...
.symper-timeline-tree-view,.milestone-datetime-item{
    display: flex;
}
.milestone-date{
    font-weight: 500;
...
.milestone-date, .milestone-datetimes{
    margin-right: 15px;
    font-size: 13px;
    color: #909090;
}
