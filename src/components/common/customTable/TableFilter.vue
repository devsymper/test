<template>
    <div :class="{'symper-table-filter-container elevation-8':true, 'd-none':!showTableFilter}" @click="handleFocusFilter" style="height:400px">
        <div
        ...
        >
            ...
            <i class="mdi body-1 mdi-check float-right" :class="{'d-none': filterConfigs.sort != 'asc'}"></i>
        </div>
        <div
        ...
        >
            ...
            <i class="mdi body-1 mdi-check float-right" :class="{'d-none': filterConfigs.sort != 'desc'}"></i>
        </div>
