<template>
<div class="d-inline-block  symper-text-style-setting d-flex" style="width: fit-content;">
    <div v-for="(item, name) in items" :key="name" class="mr-1 ml-1 style-item">
            <v-icon class="fs-16"
            ...
            >   
                ...
                <PickColor :showButton="true" @input="selectedColor" v-if="isShowPickColor" v-model="value[name]" />
            </v-menu>
    </div>
</div>
</template>
