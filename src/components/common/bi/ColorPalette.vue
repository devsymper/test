<template>
    <div class="px-1">
        <div class="color-palette-item"  v-for="(color,idx) in myValue" :key="idx">
            ...
            <v-icon @click="removeColorPaletteItem(idx)" class="remove-btn">mdi-close-circle</v-icon>
        </div>
        <div class="color-palette-item" style="top:0px">
            <div class="item-color" style="display: inline-block;text-align:center"
            @click="addColor"
            >
            <span style="top: 1px;position: absolute;left: 8px;font-size: 16px;">+</span>
            </div>
        </div>
        <v-dialog
            v-model="isShow"
...
export default {
    ...
    props:{
        value: {
            type: Array,
            default: ["#333333","#bababa","#01B8AA","#374649","#FD625E","#F2C80F","#5F6B6D","#8AD4EB","#FE9666","#A66999","#73B761","#4A588A","#ECC846","#CD4C46"]
        },
        items: {
            type: Array,
            default(){
