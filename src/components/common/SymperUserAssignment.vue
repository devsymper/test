<template>
    <div class="symper-user-assignment">
        <div class="symper-user-assignment-orgchart" v-show="activeTab == 'orgchart'">
            <v-combobox
            ...
            >
                <template v-slot:selection="{ attrs, item, select, selected }">
                    <v-chip color="blue-grey lighten-5" close-icon="mdi-close" v-bind="attrs" :input-value="selected" close x-small @click="select" @click:close="removeItem(item)">
                ...
                <template v-slot:item="{ index, item }">
                    <i style="font-size: 16px" :class="'mdi  mr-1 '+itemIconMap[item.type]"></i>
