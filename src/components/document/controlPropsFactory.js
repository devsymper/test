...
const controlTypes = {
    ...
    label: {
        ...
        html: `<label class="s-control s-control-label" contenteditable="false" s-control-type="label"  title="Label">Aa</label>&nbsp;`,
        title: "Label",
        notInProps: ['isVarchar','isQuickSubmit', 'isShowHeaderTinyMce', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatNumber', 'formatDate', 'isSumTable', 'isReadOnly'],
    ...
    qrCode: {
        ...
        title: "QrCode",
        notInProps: ['isVarchar','isQuickSubmit','isShowHeaderTinyMce', 'defaultValue', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'otherInfo', 'formatDate', 'fontSize', 'color', 'formatNumber', 'isSumTable', 'isRequired', 'isAllowUpdate', 'isReadOnly', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['linkConfig', 'formulas', 'hidden']
    },
    image: {
        ...
        title: "Image",
        notInProps: ['isVarchar','isQuickSubmit','isShowHeaderTinyMce', 'defaultValue', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'otherInfo', 'formatDate', 'fontSize', 'color', 'formatNumber', 'isSumTable', 'isRequired', 'isDBOnly', 'isTableOnly', 'isAllowUpdate', 'isReadOnly', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['linkConfig', 'formulas', 'hidden']
    },
    textInput: {
        ...
        title: "Text input",
        notInProps: ['autoHeight', 'dataFlowId', 'formatNumber', 'formatDate','isShowHeaderTinyMce', 'isSumTable', 'isAllowUpdate'],
    ...
    department: {
        ...
        title: "Department",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight', 'dataFlowId', 'isPrimaryKey','isShowHeaderTinyMce', 'formatNumber', 'formatDate', 'isSumTable', 'isAllowUpdate'],
    ...
    number: {
        ...
        title: "Number",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight','isShowHeaderTinyMce', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatDate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    date: {
        ...
        title: "Date",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight', 'dataFlowId','isShowHeaderTinyMce', 'isPrimaryKey', 'minValue', 'maxValue', 'otherInfo', 'formatNumber', 'isSumTable', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    dateTime: {
        ...
        title: "Date time",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight', 'dataFlowId','isShowHeaderTinyMce', 'isPrimaryKey', 'minValue', 'maxValue', 'otherInfo', 'formatNumber', 'formatDate', 'isSumTable', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['formulas', 'hidden', 'readOnly', 'require', 'validate']
    },
    time: {
        icon: "/icon/ic_date.png",
    ...
    month: {
        ...
        title: "Month",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight','isShowHeaderTinyMce', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'otherInfo', 'formatNumber', 'formatDate', 'isSumTable', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['formulas', 'hidden', 'readOnly', 'require', 'validate']
    },
    select: {
        ...
        title: "Select",
        notInProps: ['isVarchar','autoHeight', 'dataFlowId', 'isPrimaryKey','isShowHeaderTinyMce', 'minValue', 'maxValue', 'formatNumber', 'isSumTable', 'formatDate', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    documentSelect: {
        ...
        notInProps: ['isVarchar','autoHeight', 'dataFlowId','isShowHeaderTinyMce', 'isPrimaryKey', 'minValue', 'maxValue', 'formatNumber', 'isSumTable', 'formatDate', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    phone: {
        ...
        title: "Phone",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight','isShowHeaderTinyMce', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatNumber', 'isSumTable', 'formatDate', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['formulas', 'hidden', 'readOnly', 'require', 'validate']
    },
    email: {
    ...
    radio: {
        ...
        title: "Radio",
        notInProps: ['isVarchar','isQuickSubmit', 'autoHeight', 'isShowHeaderTinyMce','dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'mobileProps', 'formatDate', 'formatNumber', 'isPrimary', 'isMobile', 'isSumTable', 'isDBOnly', 'isRequired', 'isTableOnly', 'isTableOnly', 'isAllowUpdate', 'isReadOnly', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['formulas', 'hidden', 'readOnly', 'require']
    },
    checkbox: {
        ...
        title: "Checkbox",
        notInProps: ['isVarchar','isShowHeaderTinyMce','isQuickSubmit', 'defaultValue', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'otherInfo', 'formatDate', 'fontSize', 'formatNumber', 'isSumTable', 'isDBOnly', 'isRequired', 'isTableOnly', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue', 'isBorderPrint'],
        formulas: ['formulas', 'hidden', 'readOnly', 'require']
    },
    color: {
        icon: "/icon/ic_date.png",
    ...
    percent: {
        ...
        title: "Percent",
        notInProps: ['displayFieldInUser','isShowHeaderTinyMce','isVarchar','isQuickSubmit', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatDate', 'isSumTable', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    user: {
        ...
        title: "User",
        notInProps: ['isShowHeaderTinyMce','isVarchar','isQuickSubmit', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatNumber', 'formatDate', 'isSumTable', 'isDBOnly', 'isTableOnly', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    inputFilter: {
        ...
        title: "Input filter",
        notInProps: ['isShowHeaderTinyMce','isVarchar','autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatNumber', 'formatDate', 'isSumTable', 'isTableOnly', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue'],
    ...
    hidden: {
        ...
        title: "Hidden",
        notInProps: ['isShowHeaderTinyMce','isVarchar','isQuickSubmit', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'formatNumber', 'formatDate', 'isSumTable', 'isAllowUpdate'],
        formulas: ['formulas', 'hidden', 'readOnly', 'require', 'validate']
    },
    table: {
        ...
        title: "Table",
        notInProps: ['isVarchar','isShowHeaderTinyMce','isQuickSubmit', 'defaultValue', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'width', 'height', 'formatDate', 'isPrimary', 'formatNumber', 'isSumTable', 'isRequired', 'isDBOnly', 'isTableOnly', 'isAllowUpdate', 'isDisplayCompact', 'isMultipleValue', 'isBorderPrint'],
    ...
    panel: {
        ...
        title: "Panel",
        notInProps: ['isShowHeaderTinyMce','isVarchar','isQuickSubmit', 'defaultValue', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'fontSize', 'formatNumber', 'formatDate', 'isPrimary', 'isSumTable', 'isRequired', 'isDBOnly', 'isTableOnly', 'isAllowUpdate', 'isReadOnly', 'isDisplayCompact', 'isMultipleValue', 'isBorderPrint'],
        formulas: ['hidden']
    },
    fileUpload: {
        ...
        title: "File upload",
        notInProps: ['isShowHeaderTinyMce','isVarchar','isQuickSubmit', 'defaultValue', 'autoHeight', 'dataFlowId', 'isPrimaryKey', 'minValue', 'maxValue', 'width', 'height', 'formatDate', 'fontSize', 'color', 'mobileProps', 'isPrimary', 'formatNumber', 'isMobile', 'isSumTable', 'isDBOnly', 'isTableOnly', 'isAllowUpdate', 'isReadOnly', 'isDisplayCompact', 'isMultipleValue'],
        formulas: ['hidden']
    },
    report: {
